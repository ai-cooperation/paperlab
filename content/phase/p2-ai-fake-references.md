...
summary: "ChatGPT 生成的引用有 30-40% 的 DOI 是假的。用多工具交叉驗證法，5 步杜絕假文獻。"
weight: 2
---
...
Zotero 搭配 CrossRef + Semantic Scholar + OpenAlex 三重 API 驗證，可以半自動化這個流程。完整的自動化腳本是付費訂閱的內容。

---

*這是 [Paper Lab 11 Phase 方法學](/phases/) 的 Phase 2：文獻調研。*
