...
找到 gap 後，用 AI 分析這個 gap 適合投哪些期刊：
...
用 Semantic Scholar 或 Google Scholar 搜尋你定義的 gap 的關鍵字組合。如果搜不到完全匹配的論文，再用 AI 幫你做一輪確認。不需要 100% 確定 — 只要你找不到、AI 也找不到、教授也沒聽過，就可以先往下做。
...
*這是 [Paper Lab 11 Phase 方法學](/phases/) 的 Phase 3：研究定位。*
